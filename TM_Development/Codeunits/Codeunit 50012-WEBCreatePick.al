codeunit 50012 "WEB Create Pick"
{
    ...
    local procedure CreateTempLine2(LocationCode: Code[10]; ItemNo: Code[20]; VariantCode: Code[10]; UnitofMeasureCode: Code[10]; FromBinCode: Code[20]; ToBinCode: Code[20]; QtyPerUnitofMeasure: Decimal; var TotalQtytoPick: Decimal; var TempWhseItemTrkgLine: Record "Whse. Item Tracking Line" temporary; var TotalQtytoPickBase: Decimal)
    var
        QtytoPick: Decimal;
        QtytoPickBase: Decimal;
    ...
    local procedure InsertTmpActLnFromMovWkshLine(LocationCode: Code[10]; ItemNo: Code[20]; VariantCode: Code[10]; FromBinCode: Code[20]; QtyPerUnitofMeasure: Decimal; var TotalQtytoPick: Decimal; var TempWhseItemTrkgLine: Record "Whse. Item Tracking Line"; var TotalQtyToPickBase: Decimal)
    var
    ...
    local procedure CalcBWPickBin(LocationCode: Code[10]; ItemNo: Code[20]; VariantCode: Code[10]; UnitofMeasureCode: Code[10]; QtyPerUnitofMeasure: Decimal; var TotalQtyToPick: Decimal; var TotalQtytoPickBase: Decimal; var TempWhseItemTrkgLine: Record "Whse. Item Tracking Line"; CrossDockFirst: Boolean)
    var
        WhseSource2: Option;
    begin
        // Basic warehousing
    ...
    local procedure FindBWPickBin(LocationCode: Code[10]; ItemNo: Code[20]; VariantCode: Code[10]; ToBinCode: Code[20]; UnitofMeasureCode: Code[10]; QtyPerUnitofMeasure: Decimal; DefaultBin: Boolean; var TotalQtyToPick: Decimal; var TotalQtyToPickBase: Decimal; var TempWhseItemTrkgLine: Record "Whse. Item Tracking Line"; CrossDockFirst: Boolean)
    var
        FromBinContent: Record "Bin Content";
        QtyAvailableBase: Decimal;
        QtyToPickBase: Decimal;
    ...
    local procedure CalcPickBin(LocationCode: Code[10]; ItemNo: Code[20]; VariantCode: Code[10]; UnitofMeasureCode: Code[10]; ToBinCode: Code[20]; QtyPerUnitofMeasure: Decimal; var TotalQtytoPick: Decimal; var TempWhseItemTrkgLine: Record "Whse. Item Tracking Line"; CrossDock: Boolean; var TotalQtytoPickBase: Decimal)
    begin
    ...
    local procedure FindPickBin(LocationCode: Code[10]; ItemNo: Code[20]; VariantCode: Code[10]; UnitofMeasureCode: Code[10]; ToBinCode: Code[20]; var TempWhseActivLine2: Record "Warehouse Activity Line"
     temporary; var TotalQtytoPick: Decimal; var TempWhseItemTrkgLine: Record "Whse. Item Tracking Line"; CrossDock: Boolean; var TotalQtytoPickBase: Decimal)
    var
    ...
    local procedure FindBreakBulkBin(LocationCode: Code[10]; ItemNo: Code[20]; VariantCode: Code[10]; ToUOMCode: Code[10]; ToBinCode: Code[20]; ToQtyPerUOM: Decimal; var TempWhseActivLine2: Record "Warehouse Activity Line" temporary; var TotalQtytoPick: Decimal; var TempWhseItemTrkgLine: Record "Whse. Item Tracking Line"; CrossDock: Boolean; var TotalQtytoPickBase: Decimal)
    var
        FromItemUOM: Record "Item Unit of Measure";
        FromBinContent: Record "Bin Content";
        FromQtyToPick: Decimal;
    ...
    local procedure FindSmallerUOMBin(LocationCode: Code[10]; ItemNo: Code[20]; VariantCode: Code[10]; UnitofMeasureCode: Code[10]; ToBinCode: Code[20]; QtyPerUnitOfMeasure: Decimal; var TotalQtytoPick: Decimal; var TempWhseItemTrkgLine: Record "Whse. Item Tracking Line"; CrossDock: Boolean; var TotalQtytoPickBase: Decimal)
    var
