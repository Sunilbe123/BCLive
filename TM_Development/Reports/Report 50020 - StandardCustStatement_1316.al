report 50020 "StandardCustomerStatement"
{
    // version NAVW113.07

    RDLCLayout = './StandardCustomerStatement_50020.rdlc';
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            dataitem("Integer"; Integer)
            {
                ...
                // {
                // }
                column(BankName_CompanyInfo; BankName)
                {
                }
                column(BankAccNo_CompanyInfo; BankAccountNo)
                {
                }
                column(BankBranchNo_CompanyInfo; BankBranchNo)
                {
                }
                //MITL3895 **
                ...
                //MITL3895 ++
                column(BankBranchNo_CompanyInfoCaption; 'Sort Code')
                {
                }
                //MITL3895 **
                    ...
                    dataitem(CustLedgEntryHdr; Integer)
                    {
                        ...
                        dataitem(DtldCustLedgEntries; "Detailed Cust. Ledg. Entry")
                        {
                            ...
                            begin
                                ...
                                CASE "Entry Type" OF
                                    "Entry Type"::"Initial Entry":
                                        BEGIN
                                            ...
                                            CustLedgerEntry.SetFilter("Remaining Amount", '<>%1', 0);//MITL_VS_23Dec2019
                                            RemainingAmount := CustLedgerEntry."Remaining Amount";
                                            CustBalance := CustBalance + CustLedgerEntry."Remaining Amount";//MITL_VS_23Dec2019
                                ...
                                IF RemainingAmount = 0 then//mitl_vs_23Dec2019
                                    CurrReport.Skip(); //mitl_vs_23Dec2019
                                //CustBalance := CustBalance + Amount;//original code commented mitl_vs_23Dec2019
                                //CustBalance := CustBalance + RemainingAmount;//mitl_vs_23Dec2019
            ...
            begin
                ...
                IF NOT PrintLine THEN
                    CurrReport.SKIP;
                CompanyInfo.GET;
                //FormatAddr.Customer(CustAddr, Customer);  //MITL3895
                CustomerAddr(CustAddr, Customer); //MITL3895
                CurrReport.PAGENO := 1;
                ...
                if CustomerBankAccount.get("Our Account No.") then begin
            ...
            begin
                ...
                IF CustomerNoGlobal <> '' THEN
                    SETRANGE("No.", CustomerNoGlobal);
            end;
        }
    }
    ...
    requestpage
    {
        ...
        trigger OnInit()
        begin
            // MITL.SM.Statement Report Correciton 12.02.2020 ++
            // StartDate := 20180101D;
            // EndDate := WORKDATE;
            // MITL.SM.Statement Report Correciton 12.02.2020 --
        end;
    ...
    var
        ...
        Cust: Record Customer; //MITL3895
        BankBranchNo: Code[50];  //MITL3895
        BankAccountNo: Text[150]; //MITL3895
        BankName: Text[150]; //MITL3895
        CustomerBankAccount: Record "Bank Account"; //MITL3895
        AddressFormat: Codeunit "Format Address"; //MITL3895
    ...
    begin
        ...
        EndDate := NewEndDate;
        CustomerNoGlobal := CustomerNo; // MITL
    end;
    ...
    //MITL3895 ++
    Local Procedure CustomerAddr(VAR AddrArray: ARRAY[8] OF Text; VAR Cust: Record Customer)
    begin
        WITH Cust DO
            AddressFormat.FormatAddr(
              AddrArray, Name, Address, "Address 2",
