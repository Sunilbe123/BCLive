report 50014 "CalculateBinReplenishment"
{
    // version NAVW113.00
    ...
    dataset
    {
        dataitem("Bin Content"; "Bin Content")
        {
            ...
            begin
                ...
                WhseWkshLine.SETFILTER(Quantity, '>%1', 0);
                IF WhseWkshLine.FINDFIRST THEN
                    WhseWkshLine.MovementCreate(WhseWkshLine)
                // ELSE
                //     ERROR(Text001);
            end;
        }
    ...
    var
        ...
        Replenishmt: Codeunit Replenishment_Custom;
