table 50037 "Pick Crt_Buffer2"
{
    // version CASE13605

    Caption = 'Finded Stock entries';
    ...
    fields
    {
        ...
        field(7383; "Remaning Qty"; Decimal)
        {
    ...
    keys
    {
        ...
        key(Key4; "Item No.", "Bin Code", "Location Code", "Variant Code", "Unit of Measure Code", "Lot No.", "Serial No.", "Entry Type", Dedicated)
        {
            MaintainSIFTIndex = false;
            SumIndexFields = "Qty. (Base)", Cubage, Weight, Quantity;
        }
        key(Key5; "Item No.", "Location Code", "Variant Code", "Bin Type Code", "Unit of Measure Code", "Lot No.", "Serial No.", Dedicated)
        {
            SumIndexFields = "Qty. (Base)", Cubage, Weight;
        }
        key(Key6; "Bin Code", "Location Code", "Item No.")
        {
            SumIndexFields = Cubage, Weight, "Qty. (Base)";
        }
        key(Key7; "Location Code", "Item No.", "Variant Code", "Zone Code", "Bin Code", "Lot No.")
        {
        ...
        key(Key9; "Registering Date")
        {
        }
        key(Key10; "Registering Date", "Location Code", "Item No.", "Bin Code")
        {
        }
    }
