table 50035 "Pick Crt_Whse Shp Lines"
{
    // version CASE13605

    Caption = 'No Stock Lines';
    ...
    keys
    {
        ...
        {
            MaintainSQLIndex = false;
            SumIndexFields = "Qty. Outstanding (Base)", "Qty. (Base)", Quantity, "Qty. Picked (Base)";
        }
        ...
        key(Key13; "Location Code", "Zone Code", "Bin Code", "Item No.")
        {
            SumIndexFields = "Qty. Outstanding (Base)", "Qty. (Base)", Quantity, "Qty. Picked (Base)";
        }
        key(Key14; "Due Date", "Source Document", "Source No.")
        {
        }
    }
